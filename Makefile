...
# 100%适配独立插件仓库，与脚本版核心代码完全同步，全架构通用
include $(TOPDIR)/rules.mk

# 单源唯一版本号，与脚本版强制绑定，改一次全同步
...
# 禁用冗余交叉编译，纯脚本插件无需编译，云编译耗时≤30秒
define Build/Compile
endef

# 安装规则，与脚本版安装逻辑100%完全对齐
